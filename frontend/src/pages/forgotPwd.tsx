...
import {ResetPwdEmail} from "../components/resetPwdEmail";

const ForgotPwd: React.FC = () => {
    return (
        <div
            className="bg-fixed bg-gradient-to-b from-transparent to-black bg-cover bg-center bg-no-repeat lg:bg-contain h-screen"
            style={{
